...
async function syncFromCentralDatabase() {
  try {
    ...
    if (response.ok) {
      ...
      if (Array.isArray(db.sucursales)) sucursales = db.sucursales;
      if (Array.isArray(db.categories)) categories = db.categories;
      if (Array.isArray(db.workers)) workers = db.workers;
      if (Array.isArray(db.services)) services = db.services;
      if (Array.isArray(db.courses)) courses = db.courses;
      if (Array.isArray(db.requestedGroups)) requestedGroups = db.requestedGroups;
      if (Array.isArray(db.courseReservations)) courseReservations = db.courseReservations;
      if (Array.isArray(db.benefitsClients)) {
      ...
      if (Array.isArray(db.testimonials)) testimonials = db.testimonials;
